...
namespace AdventOfCode.Day03
{
    ...
    {
        public static List<string> FirstWire => new List<string>
        {
        ...
        public static List<string> SecondWire => new List<string>
        {
    ...
    public static class ExampleOneInput
    {
        public static List<string> FirstWire => new List<string>
        {
    ...
    public static class ExampleTwoInput
    {
        public static List<string> FirstWire => new List<string>
        {
